...
">
     ...
     <div className="sticky top-0 bg-white z-10 flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-100">   
        ...
        {/* ── Body ── */}
        <form onSubmit={handleSubmit(onSubmit)} className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-5 space-y-4 sm:space-y-5">
            ...
            {studentSelected && (
              <div className="mt-2 border border-[#3525CD]/30 rounded-xl overflow-hidden">
                ...
                <div className="flex items-center gap-3 px-3 py-3">
                  <div className="w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center text-sm sm:text-xs font-bold text-indigo-700 shrink-0">
                    RK
                  </div>

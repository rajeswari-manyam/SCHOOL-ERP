      ...
      <div className="bg-white rounded-t-xl sm:rounded-xl shadow-2xl w-full sm:max-w-md flex flex-col max-h-[92vh] sm:max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gray-50/60 shrink-0">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <Button
              size="sm"
              className="hidden sm:inline-flex h-7 text-xs bg-[#3525CD] hover:bg-[#2a1fb5] text-white gap-1.5 px-3"
            >
        ...
        <div className="overflow-y-auto flex-1 p-4 sm:p-5 bg-white">
          ...
          {/* Fee Details Box */}
          <div className="bg-gray-50 rounded-lg p-3 mb-3 sm:mb-4 text-[11px]">
            {/* Fee Head + Period row */}
          ...
          <div className="flex justify-between items-end pt-3 border-t border-gray-200">
            <div className="min-w-0">
              ...
              <p className="text-[11px] font-semibold text-gray-900 truncate">{receipt.collectedBy}</p>

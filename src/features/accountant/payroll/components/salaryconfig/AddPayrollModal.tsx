...
export function AddPayrollModal({ onClose, onSuccess }: Props) {
  ...
  if (successData) {
    return (
      <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-end sm:items-center justify-center sm:p-4">
        <div className="bg-white w-full sm:max-w-[480px] sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col overflow-hidden">
          {/* Success header */}
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-end sm:items-center justify-center sm:p-4">
      <div className="bg-white w-full sm:max-w-[580px] sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col max-h-[92vh] overflow-hidden">

        {/* Header */}
        <div className="flex justify-between items-start px-5 py-4 border-b border-gray-100 flex-shrink-0">
          <div>
            <h2 className="text-sm font-semibold text-gray-900">Add Staff Payroll</h2>
            <p className="text-[11px] text-gray-400 mt-0.5">Configure salary components for a staff member</p>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="overflow-y-auto flex-1">
          ...
          {/* Footer */}
          <div className="flex gap-2 px-5 py-4 border-t border-gray-100 bg-gray-50 sm:rounded-b-2xl flex-shrink-0">
            <Button type="button" variant="outline" onClick={onClose} className="flex-1 sm:flex-none h-9 text-sm">
              Cancel
            </Button>
            <Button
              type="submit"
              disabled={submitting || !values.staff_id}
              className="flex-1 sm:flex-none h-9 text-sm bg-[#3525CD] hover:bg-[#2a1da3] text-white disabled:opacity-50 gap-1.5"
            >
              {submitting

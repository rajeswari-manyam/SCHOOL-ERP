...
const ExamsSection = ({ exams, isExamsLoading, isExamsError }: {
  exams: import("./types/timetable.types").UpcomingExam[];
    ...
    return (
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="py-8 text-center">
          <p className="text-xs text-gray-400">Exams are unavailable right now.</p>
        </div>
      </div>
    );
  }

  return <UpcomingExamsTable exams={exams} />;
};

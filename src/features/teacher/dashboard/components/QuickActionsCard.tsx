...
const actions = [
  { label: "Mark Attendance", color: "bg-[#25d366] hover:bg-[#22c55e] text-white", icon: "✅" },
  { label: "Assign Homework",  color: "bg-indigo-600 hover:bg-indigo-700 text-white", icon: "📝" },
  { label: "Upload Material",  color: "bg-blue-500 hover:bg-blue-600 text-white",    icon: "📎" },
  { label: "Apply Leave",      color: "bg-amber-500 hover:bg-amber-600 text-white",  icon: "🗓" },
  { label: "View Students",    color: "bg-gray-100 hover:bg-gray-200 text-gray-800", icon: "👥" },
];

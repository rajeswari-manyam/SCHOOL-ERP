...
import { STUDENT_IMPORT_COLUMNS } from "../types/studentImport.types";
import { IMPORT_FILE_ACCEPT } from "@/utils/importFileKind";

const PREVIEW_ROW_LIMIT = 50;

const ImportStudentsExcelPage = () => {
    ...
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col overflow-hidden">
        ...
        <div className="flex items-start justify-between px-5 sm:px-7 pt-5 pb-4 border-b border-gray-100 shrink-0">
          <div>
            <h1 className="text-lg font-bold text-gray-900 leading-tight">Import Students</h1>
            <p className="text-xs text-gray-400 mt-0.5">
              {importResult ? "Import result" : file ? "Review the file before importing" : "Upload an Excel, CSV, PDF, or Word file containing student records"}
            </p>
          </div>
              ...
              {!file && (
                <div className="rounded-2xl border-2 border-dashed border-gray-200 bg-slate-50/50 px-6 py-10 flex flex-col items-center text-center gap-3">
                  ...
                  <p className="text-sm text-gray-500 max-w-sm">
                    Upload the file containing student records — using the provided Excel template gives the best results.
                  </p>
                  <input
                    ref={fileInputRef}
                    type="file"
...
export default ImportStudentsExcelPage;

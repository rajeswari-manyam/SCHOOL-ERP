...
import {
  ArrowLeft, Loader2, Search, CheckCircle2, AlertCircle, Users,
} from "lucide-react";
import {
  getAllAcademicYears,
  promoteStudents,
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-2 text-xs text-gray-400">
        ...
        <span>›</span>
        <span className="text-gray-700 font-semibold">Promote Students</span>
      </div>

      <div className="relative w-full bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col overflow-hidden">

        {/* Header */}
        <div className="flex items-center justify-between gap-3 px-6 py-4 border-b border-gray-100 flex-shrink-0">
          <div>
            <h1 className="text-lg font-bold text-gray-900">Promote Students</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 bg-gray-50/50 rounded-xl p-4 border border-gray-100">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl border border-gray-200 bg-[#EFF4FF] px-3 py-2 text-sm text-gray-800 outline-none focus:border-indigo-500"
              >
            ...
            <div>
              ...
              <select
                ...
                disabled={!classId}
                className="w-full rounded-xl border border-gray-200 bg-[#EFF4FF] px-3 py-2 text-sm text-gray-800 outline-none focus:border-indigo-500 disabled:opacity-50"
              >

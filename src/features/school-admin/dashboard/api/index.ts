...
const MOCK_DASHBOARD: DashboardData = {
  stats: [
    { id: 'attendance', label: 'STUDENTS PRESENT TODAY', value: '318/342', badge: { text: '93% RATE', variant: 'green' }, sub: '24 absent across 8 classes', action: { label: 'View Details →' }, icon: 'users' },
    { id: 'classes', label: 'CLASSES MARKED TODAY', value: '12/15', badge: { text: '● Action needed', variant: 'orange' }, sub: '3 classes pending', action: { label: 'Send Reminders →' }, alert: true, icon: 'check' },
    { id: 'fees', label: 'COLLECTED THIS MONTH', value: '₹2,34,000', badge: { text: '66% PAID', variant: 'blue' }, sub: '₹1,18,000 still pending', action: { label: 'View Defaulters →' }, icon: 'rupee' },
    { id: 'admissions', label: 'ADMISSIONS THIS WEEK', value: '7', badge: { text: '+2 vs LW', variant: 'green' }, sub: '3 pending follow-up', action: { label: 'View Pipeline →' }, icon: 'user-plus' },
  ],
  attendanceClasses: [

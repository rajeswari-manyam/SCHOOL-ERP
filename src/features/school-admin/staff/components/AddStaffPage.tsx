...
import { ArrowLeft, ChevronDown, Camera, Trash2 } from "lucide-react";
...
const inputBase = "w-full h-11 px-3.5 rounded-xl bg-[#EFF4FF] text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 transition";
...
const selectCls =
  "w-full h-11 pl-3.5 pr-9 rounded-xl bg-[#EFF4FF] border border-slate-200 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 appearance-none transition";
...
export const AddStaffPage = () => {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // user waiting on the list/stats/leaves refetch before navigating.
      loadStaff();
    } catch (error: unknown) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-2 text-xs text-gray-400">
        ...
        <span>›</span>
        <span className="text-gray-700 font-semibold">Add Staff Member</span>
      </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div className="p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4 flex-1">
            ...
            <div>
              ...
              <div className={`flex h-11 rounded-xl border overflow-hidden focus-within:ring-2 transition bg-[#EFF4FF] ${errors.phone ? "border-red-400 focus-within:ring-red-300" : "border-slate-200 focus-within:ring-indigo-300 focus-within:border-indigo-400"}`}>
                <span className="flex items-center px-3.5 bg-slate-100 border-r border-slate-200 text-sm font-semibold text-gray-600 shrink-0">
                  +91
                </span>
                <input
                  type="tel"
            ...
            <div>
              ...
              <input
                className={
                  autoGenEmp
                    ? inputCls.replace("bg-[#EFF4FF]", "bg-slate-100") + " text-gray-500 cursor-not-allowed select-none"
                    : inputCls
                }

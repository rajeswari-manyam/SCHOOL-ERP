    ...
    <div className="flex flex-col gap-0 min-h-full -m-4 md:-m-6">
      ...
      <div className="flex flex-col gap-6 p-4 md:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div>
            <h1 className="text-lg font-bold text-gray-900 tracking-tight">WhatsApp Templates</h1>
            <p className="text-xs sm:text-sm text-gray-500 mt-0.5">Manage Meta-approved templates across all schools</p>
          </div>

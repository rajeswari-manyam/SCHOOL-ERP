...
} from "@/features/super-admin/whatsapp-templates/types/templates.types";
...
export const templatesApi = {
  ...
  getStats: async (): Promise<import("@/features/super-admin/whatsapp-templates/types/templates.types").TemplateStats> => {
